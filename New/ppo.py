...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="HumanoidStandup-v4")
...
def test_ppo(args=get_args()):
    ...
    def dist(*logits):
        ...
        print(*logits)
        # if len(logits) != 2:
        #     raise ValueError("Expected two tensors: mean and log_std")

        mean, log_std = logits[0]  # Unpack mean and log_std tensors

        # Convert log_std to std
        std = torch.exp(log_std)

        # Create the Normal distribution using mean and std
